		...
		<div class="b-block">
			<div class="b-5-content">
				...
				<div class="b-5-list">
					...
					<div class="b-5-item">
						<a href="mailto:info@m1.moscow" class="with-border with-icon icon-email">info@m1.moscow</a>
					</div>
					<div class="b-5-item">
